...
/**
 * Settings – repository connection and account management.
 */
export default function Settings() {
  ...
  const handleConnect = async (e) => {
    ...
    try {
      // POST request to /integrations as requested by Phase 2 requirements
      ...
      if (import.meta.env.DEV && (err.status === 0 || err.code === 'ERR_NETWORK')) {
        console.warn('[Settings] Backend unreachable — simulating successful connection.')
